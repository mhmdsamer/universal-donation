...
if(isset($_POST['submit']))
{
    ...
    $query="insert into food_donations(email,food,category,phoneno,location,address,name,quantity) values('$emailid','$foodname','$category','$phoneno','$district','$address','$name','$quantity')";
