...
<body style="    background-color: #06C167;">
    ...
    <form action="" method="post">
       ...
       <div class="input">
        ...
        <input placeholder="clothes" type="text" id="foodname" name="foodname" required/>
        </div>
        ...
        <div class="image-radio-group">
            <input type="radio" id="winter" name="image-choice" value="winter">
            <label for="winter">
              <img src="img/winter.png" alt="winter" style="height: 200px; width: 230px;" >
            </label>
            <input type="radio" id="summer" name="image-choice" value="summer">
            <label for="summer">
              <img src="img/summer.webp" alt="summer" style="height: 200px; width: 230px;" >
            </label>
